...
timeLine <- c(0 , 500)
sportLine <- c(0 , 40 )
plot(y = regulardata$Count , x = regulardata$Score,
     ylab="Student count" , xlab = "Scores" ,type="p",
     ylim=sportLine , xlim=timeLine , lty = 1, lwd = 1, col = "blue" )

lines(y = sportsdata$Count , x = sportsdata$Score , pch = 18, col = "red", type = "p", 
      lty = 2, lwd = 1)
